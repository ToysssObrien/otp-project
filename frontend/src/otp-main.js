...
const translations = {
  ...
  th: {
    eyebrow: "iCash Security",
    brand_title: "OTP Access<br>for iCash",
    brand_copy: "ยืนยันตัวตนอย่างปลอดภัยผ่านรหัส OTP เพื่อเข้าใช้งานระบบ iCash ได้อย่างมั่นใจ ทั้งในขั้นตอนทดสอบและการเชื่อมต่อใช้งานจริง",
    step1_title: "กรอกเบอร์โทรศัพท์",
    step1_desc: "รองรับเบอร์กัมพูชาแบบ local หรือรูปแบบสากล E.164",
    step2_title: "รับรหัส OTP",
    step2_desc: "ระบบจะส่งรหัสผ่านผู้ให้บริการ SMS ที่ตั้งค่าไว้ในระบบ",
    step3_title: "ยืนยันเพื่อเข้าใช้งาน",
    step3_desc: "กรอกรหัส 6 หลักเพื่อปิดขั้นตอนยืนยันตัวตนให้สมบูรณ์",
    footer_left: "ประสบการณ์เข้าสู่ระบบอย่างปลอดภัยสำหรับการทดสอบภายใน",
    footer_right: "OTP Backend Service",
    kicker: "Verification",
    header_h1: "ยืนยันตัวตนเพื่อเข้าสู่ระบบ",
    header_p: "กรอกเบอร์โทรศัพท์เพื่อขอรหัส OTP จากนั้นกรอกรหัส 6 หลักที่ได้รับเพื่อยืนยันตัวตน",
    label_phone: "เบอร์โทรศัพท์",
    control_language: "ภาษา",
    control_theme: "ธีม",
    placeholder_phone: "0971234567 หรือ +855971234567",
    btn_request: "ขอรหัส OTP",
    label_otp: "รหัส OTP 6 หลัก",
    placeholder_otp: "123456",
    btn_verify: "ยืนยันรหัส",
    note: "สำหรับการทดสอบจริง ผู้ให้บริการ SMS และสิทธิ์การส่งจะขึ้นอยู่กับ environment ที่ตั้งค่าไว้บนระบบ",
    status_phone_invalid: "กรุณากรอกเบอร์โทรศัพท์ให้ถูกต้อง",
    status_server_error: "ไม่สามารถเชื่อมต่อกับเซิร์ฟเวอร์ได้",
    request_failed: "เกิดข้อผิดพลาดในการขอ OTP",
    request_success: "ส่งรหัส OTP สำเร็จ",
    verify_prompt: "กรุณากรอกรหัส OTP 6 หลัก",
    verify_failed: "รหัส OTP ไม่ถูกต้อง",
    verify_success: "ยืนยันรหัส OTP สำเร็จ",
    utility_title: "OTP Hub"
  },
  kh: {
    eyebrow: "សុវត្ថិភាព iCash",
    brand_title: "ការចូលប្រើ OTP<br>សម្រាប់ iCash",
    brand_copy: "ផ្ទៀងផ្ទាត់អត្តសញ្ញាណរបស់អ្នកដោយសុវត្ថិភាពតាមរយៈ OTP ដើម្បីចូលប្រើប្រព័ន្ធ iCash ទាំងក្នុងការសាកល្បង និងបរិស្ថានផ្ទាល់។",
    step1_title: "បញ្ចូលលេខទូរស័ព្ទ",
    step1_desc: "គាំទ្រលេខកម្ពុជាក្នុងប្រទេស ឬទម្រង់អន្តរជាតិ E.164",
    step2_title: "ទទួល OTP",
    step2_desc: "ប្រព័ន្ធនឹងផ្ញើកូដតាមរយៈអ្នកផ្តល់សេវា SMS ដែលបានកំណត់",
    step3_title: "ផ្ទៀងផ្ទាត់ដើម្បីចូលប្រើ",
    step3_desc: "បញ្ចូលលេខកូដ 6 ខ្ទង់ ដើម្បីបញ្ចប់ដំណើរការផ្ទៀងផ្ទាត់",
    footer_left: "បទពិសោធន៍ចូលប្រើដែលមានសុវត្ថិភាព សម្រាប់ការសាកល្បងផ្ទៃក្នុង",
    footer_right: "សេវាកម្ម Backend OTP",
    kicker: "ការផ្ទៀងផ្ទាត់",
    header_h1: "ផ្ទៀងផ្ទាត់អត្តសញ្ញាណ ដើម្បីចូលប្រើ",
    header_p: "បញ្ចូលលេខទូរស័ព្ទរបស់អ្នក ដើម្បីស្នើ OTP បន្ទាប់មកបញ្ចូលលេខកូដ 6 ខ្ទង់ដែលបានទទួល ដើម្បីផ្ទៀងផ្ទាត់អត្តសញ្ញាណរបស់អ្នក។",
    ...
    note: "សម្រាប់ការសាកល្បងពិត អ្នកផ្តល់សេវា SMS និងសិទ្ធិផ្ញើ អាស្រ័យលើការកំណត់បរិស្ថានប្រព័ន្ធ។",
    status_phone_invalid: "សូមបញ្ចូលលេខទូរស័ព្ទដែលត្រឹមត្រូវ",
    status_server_error: "មិនអាចភ្ជាប់ទៅកាន់ម៉ាស៊ីនមេបានទេ",
    request_failed: "មិនអាចស្នើ OTP បានទេ",
    request_success: "បានផ្ញើ OTP ដោយជោគជ័យ",
    verify_prompt: "សូមបញ្ចូល OTP 6 ខ្ទង់",
    verify_failed: "កូដ OTP មិនត្រឹមត្រូវ",
    verify_success: "បានផ្ទៀងផ្ទាត់ OTP ដោយជោគជ័យ",
    utility_title: "ផ្ទាំង OTP"
  }
};
